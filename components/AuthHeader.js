  ...
  return (
    <header className="sticky top-0 z-40 bg-white/90 backdrop-blur-md border-b border-gray-200" style={{ isolation: 'isolate' }}>
      <div className="max-w-5xl mx-auto px-6 h-14 flex items-center justify-between">
        <Link href="/" prefetch={false} className="flex items-center gap-2.5 no-underline group">
        ...
        <nav className="flex items-center gap-2">
          <Link
            href="/login"
            prefetch={false}
            className={`px-3.5 py-1.5 rounded-lg text-sm font-medium transition-all no-underline ${
              active === 'login'
          ...
          <Link
            href="/register"
            prefetch={false}
            className={`px-3.5 py-1.5 rounded-lg text-sm font-semibold transition-all no-underline ${
              active === 'register'
                ? 'bg-indigo-50 text-indigo-700'
