  ...
  if (quizPhase === 'practice' && activeExam) {
    ...
    return (
      <div className="fixed inset-0 z-50 bg-[#f8f9fb] flex flex-col" style={{ fontFamily: "var(--font-be-vietnam), system-ui, sans-serif", color: 'var(--et-gray-800)' }}>
        ...
        />
        {reportModal.isOpen && <ReportModal reportModal={reportModal} setReportModal={setReportModal} user={user} activeExam={activeExam} showAlert={showAlert} REPORT_REASONS={REPORT_REASONS} />}
