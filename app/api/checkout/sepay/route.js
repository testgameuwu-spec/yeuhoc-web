...
export async function POST(request) {
  try {
    ...
    const checkoutFormfields = client.checkout.initOneTimePaymentFields({
      ...
      success_url: redirectUrl ? `${redirectUrl}?payment=success` : 'https://yeuhoc-web.vercel.app/?payment=success',
      error_url: redirectUrl ? `${redirectUrl}?payment=error` : 'https://yeuhoc-web.vercel.app/?payment=error',
      cancel_url: redirectUrl ? `${redirectUrl}?payment=cancel` : 'https://yeuhoc-web.vercel.app/?payment=cancel',
    });
